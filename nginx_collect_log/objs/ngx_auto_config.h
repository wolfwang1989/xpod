#define NGX_CONFIGURE " --with-cc-opt=-O0 --user=nginx --group=nginx --add-module=src/echo-nginx-module --sbin-path=/sbin/nginx --conf-path=/etc/nginx/nginx.conf --with-http_stub_status_module"
