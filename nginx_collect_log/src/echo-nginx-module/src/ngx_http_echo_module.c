...
static char * ngx_http_echo_echo_read_request_body(ngx_conf_t *cf,
        ngx_command_t *cmd, void *conf);
static char * ngx_http_echo_echo_stat(ngx_conf_t *cf,
        ngx_command_t *cmd, void *conf);
...
static ngx_command_t  ngx_http_echo_commands[] = {
    ...
    { ngx_string("echo_stat"),
      NGX_HTTP_LOC_CONF|NGX_HTTP_LIF_CONF|NGX_CONF_NOARGS,
      ngx_http_echo_echo_stat,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_echo_loc_conf_t,handler_cmds),
      NULL },
...
static char *
ngx_http_echo_echo_stat(ngx_conf_t *cf,
        ngx_command_t *cmd, void *conf)
{
    return ngx_http_echo_helper(echo_opcode_echo_stat,
            echo_handler_cmd, cf, cmd, conf);
}
