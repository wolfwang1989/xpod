...
static void ngx_http_echo_read_client_request_body_handler(ngx_http_request_t *r);
...
*/
    if(r->method & NGX_HTTP_POST){
      rc = ngx_http_read_client_request_body(r, ngx_http_echo_read_client_request_body_handler);
...
static void ngx_http_echo_read_client_request_body_handler(ngx_http_request_t *r)
{
   printf("called:ngx_http_echo_read_client_request_body_handler\n");
