...
import com.ttpod.storm.ipstat.Reader.FileMode;
...
public  class ThreadBuffer extends ThreadLocal<ByteBuffer> implements Closeable {
    ...
    public ThreadBuffer(File database, FileMode mode) throws IOException {
     ...
     * @throws java.io.IOException  if unable to read from your source.
     * @throws NullPointerException if you provide a NULL InputStream
     */
    public ThreadBuffer(InputStream stream) throws IOException {
        if (null == stream) {
